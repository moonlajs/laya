    ...
    function() {
      ...
      , u = function() {
        ...
        e.updateStartTime = function() {
            ...
            this._gameStartDownTxt.text = "倒计时:" + this._gameStartTime) : 0 == this._gameStartTime ? (this._gameStartDownTxt.visible = !0,
            this._gameStartDownTxt.text = "游戏开始",
      ...
      , m = function() {
        ...
        e.showResult = function() {
            ...
            this._scoreTxt.text = "得分：" + c.sumScore
        }
        ,
      ...
      , et = function() {
        ...
        s.__init__ = function() {
            if (!s._window) {
                ...
                s.onMiniGame && null == s.window.focus && console.error("请先初始化小游戏适配库，详细教程https://ldc.layabox.com/doc/?nav=zh-ts-5-0-0"),
